      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <div className="animate-fade-in">
          <h1 className="heading-font text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-4 sm:mb-6 leading-tight">
            <span className="text-[#FFDB42] block sm:inline">Transformando</span> 
            <span className="block sm:inline"> Vidas</span>
            <br />
            <span className="text-[#FE6100] block sm:inline">Construindo</span> 
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 px-4">
            <Link href="/donate" className="w-full sm:w-auto text-base sm:text-lg bg-[#FE6100] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-[#e55500] transition-all duration-300 hover:scale-105 hover:shadow-lg inline-flex items-center justify-center">
              Faça uma Doação
