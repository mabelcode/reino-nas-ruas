    ...
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="aspect-[16/9] relative">
                ...
                <div className="absolute top-3 sm:top-4 right-3 sm:right-4">
                  <span className="px-2 sm:px-3 py-1 bg-[#40AD52] text-white text-xs sm:text-sm rounded-full">
                    {project.status}
                  </span>
                </div>
              </div>
              ...
              <div className="p-4 sm:p-6">
                ...
                <button className="w-full bg-gray-100 text-[#FE6100] font-semibold py-2 sm:py-3 rounded-xl hover:bg-[#FE6100] hover:text-white transition-all duration-300 flex items-center justify-center text-sm sm:text-base">
                  Saiba Mais
        ...
        <div className="text-center">
          <Link href="/what-we-do" className="inline-flex items-center bg-[#FE6100] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-[#e55500] transition-all duration-300 hover:scale-105 hover:shadow-lg text-sm sm:text-base">
