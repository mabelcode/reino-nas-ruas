        ...
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              {/* Valores Sugeridos */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold text-[#385723] mb-4">
                  Valores Sugeridos
                </h3>
              ...
              <div className="bg-gray-50 rounded-3xl p-6 mb-6">
                <h3 className="text-lg font-semibold text-[#385723] mb-4">
                  Chave PIX
                </h3>
                <div className="flex items-center justify-between bg-white rounded-xl p-4">
                  ...
                  <button
                    ...
                    className="ml-4 bg-[#FE6100] text-white p-2 rounded-lg hover:bg-[#e55500] transition-colors"
                  >
                    {copiedPix ? <CheckCircle className="w-5 h-5" /> : <Copy className="w-5 h-5" />}
                  </button>
                </div>
                {copiedPix && (
                  <p className="text-[#40AD52] text-sm mt-2">
            ...
            <div className="animate-slide-in-right">
              <div className="bg-white rounded-3xl p-8 shadow-lg text-center">
                <h3 className="text-2xl font-bold text-[#385723] mb-6">
                  QR Code PIX
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-xs rounded-3xl p-6 text-center">
              ...
              <button 
                ...
                className="bg-[#FFDB42] text-[#385723] px-6 py-2 rounded-full font-semibold hover:bg-[#e6c538] transition-colors"
              >
                Inscrever-se
              </button>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-xs rounded-3xl p-6 text-center">
              ...
              <a 
                href="/contact" 
                className="bg-[#FE6100] text-white px-6 py-2 rounded-full font-semibold hover:bg-[#e55500] transition-colors"
              >
                Saiba Mais
              </a>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-xs rounded-3xl p-6 text-center">
              ...
              <button className="bg-[#40AD52] text-white px-6 py-2 rounded-full font-semibold hover:bg-[#359544] transition-colors">
                Compartilhar
              </button>
            </div>
          </div>
